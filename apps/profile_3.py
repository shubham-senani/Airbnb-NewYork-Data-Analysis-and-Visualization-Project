        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    dbc.CardBody(
                        [
                            html.H4("LIKHITHAPUDI PRANADEEP", className="card-title mx-4"),
                            html.P(
                                "Data Wrangling"
                                ""
                                "",
                            ...
                            dbc.Button("LinkedIn", href="https://www.linkedin.com/in/pranadeep-l-990751266", color="danger", className="mx-4"),
                        ]
                    ),
                    className="col-md-8",
                ),
