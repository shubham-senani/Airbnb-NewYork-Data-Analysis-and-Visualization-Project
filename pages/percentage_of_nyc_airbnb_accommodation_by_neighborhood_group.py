...
dash.register_page(__name__,path='/percentage_of_nyc_airbnb_accommodation_by_neighborhood_group',title="Data Analysis and Visualization",description="learning simplified",image='logo2.png')

layout = html.Div(children=[
        html.Div([navbar.navbar], style={
             "z-index": "111", "position": "fixed", "width": "100%"}),
         dbc.Col([
            dcc.RadioItems(options=["graph"], value="graph", id="radio-btn12")
         ],className="d-none"),
         dbc.Col([
            dcc.Graph(id='line-graph12', figure={})
...
@dash.callback(
    Output(component_id='line-graph12', component_property='figure'),
    Input(component_id='radio-btn12', component_property='value')
)
def update_graph(stock_slctd):
    return dp.percentage_of_nyc_airbnb_accommodation_by_neighborhood_group